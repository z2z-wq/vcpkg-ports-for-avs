...
if ("davs2" IN_LIST FEATURES)
    set(OPTIONS "${OPTIONS} --enable-libdavs2")
    set(WITH_VAAPI ON)
else()
    set(OPTIONS "${OPTIONS} --disable-libdavs2")
    set(WITH_VAAPI OFF)
endif()

if ("uavs3d" IN_LIST FEATURES)
    set(OPTIONS "${OPTIONS} --enable-libuavs3d")
    set(WITH_VAAPI ON)
else()
    set(OPTIONS "${OPTIONS} --disable-libuavs3d")
    set(WITH_VAAPI OFF)
endif()
